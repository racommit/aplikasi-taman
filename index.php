...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM datamahasiswa WHERE email='$email' AND password='$password'";
...
<head>
    ...
    <title>Halaman Login Aplikasi Sederhana</title><!--begin::Primary Meta Tags-->
...
<body class="login-page bg-body-secondary">
    <div class="login-box">
        <div class="login-logo"> <a href="../index2.html"><b>Skywannn</b>SOBARI</a> </div> <!-- /.login-logo -->
        <div class="card">
    ...
    <script>
        ...
        //     if(email == "ikhwan@gmail.com" && password == "123"){
