...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    ...
    $result2 = mysqli_query($conn, "SELECT * FROM datamahasiswa ORDER BY id ASC");
    $sql3 = "SELECT DATE(waktu) as tanggal, COUNT(*) as jumlah FROM tb_pesanan GROUP BY DATE(waktu)";
    $result3 = $conn->query($sql3);

    $data = array();
    if ($result3->num_rows > 0) {
        // Mengambil hasil dan menyimpan ke dalam array
        ...
        <div class="app-content"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Row-->
                <div class="row"> <!--begin::Col-->
                    ...
                    <div class="col-lg-6 col-6"> <!--begin::Small Box Widget 3-->
                        <div class="small-box text-bg-warning">
                            <div class="inner">
                                <h3><?= $result2->num_rows ?></h3>
                                <p>Pelanggan</p>
                            </div> <svg class="small-box-icon" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <div class="row"> <!-- Start col -->
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h3 class="card-title">Pesanan Tabel</h3>
                        </div> <!-- /.card-header -->
                        <div class="card-body">
                            <div class="container-fluid"> <!--begin::Row-->
    ...
    <script>
        ...
        // Memisahkan data tanggal dan jumlah
        const dates = dataFromPHP.map(item => item.tanggal);
        const counts = dataFromPHP.map(item => item.jumlah);
        console.log(dates);
