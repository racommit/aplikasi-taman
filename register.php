        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="" method="post">
                    <div class="input-group mb-3"> <input name="fullname" type="text" class="form-control" placeholder="Full Name">
                    ...
                    <div class="input-group mb-3"> <input name="handphone" type="number" class="form-control" placeholder="Hand Phone">
                        <div class="input-group-text"> <span class="bi bi-telephone"></span> </div>
                    </div>
                    <div class="input-group mb-3"> <input name="gender" type="radio" id="pria" class="gender" value="pria"> <label for="pria"> Pria </label>
                        <input name="gender" type="radio" id="wanita" class="gender" value="wanita"> <label for="wanita"> Wanita </label>   
                    </div>
                    <div class="input-group mb-3"> <input name="alamat" type="text" class="form-control" placeholder="Alamat">
                ...
                <p class="mb-0"> <a href="index.php" class="text-center">
